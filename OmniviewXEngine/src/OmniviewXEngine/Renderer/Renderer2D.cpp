...
#include "OmniviewXEngine/Renderer/Renderer2D.h"
...
namespace OmniviewXEngine 
{
	...
	void Renderer2D::Init()
	{
		...
		s_Data.QuadShader 	= 	Shader::Create("/home/adas/CV/sourcecode/OmniviewXEngine/Appbox/assets/shaders/Renderer2D_Quad.glsl");
		// s_Data.CircleShader = 	Shader::Create("assets/shaders/Renderer2D_Circle.glsl");
		// s_Data.LineShader 	= 	Shader::Create("assets/shaders/Renderer2D_Line.glsl");
		s_Data.TextShader 	= 	Shader::Create("/home/adas/CV/sourcecode/OmniviewXEngine/Appbox/assets/shaders/Renderer2D_Text.glsl");
	...
	void Renderer2D::DrawQuad(const glm::mat4& transform, const glm::vec4& color, int entityID)
	{
		...
		// 检查当前的渲染批次中的顶点数量是否已经达到了最大限制
		// 如果达到了最大限制（MaxIndices 是一个用于限制批次中顶点数量的常量
		// 则调用 NextBatch() 函数切换到下一个渲染批次。
