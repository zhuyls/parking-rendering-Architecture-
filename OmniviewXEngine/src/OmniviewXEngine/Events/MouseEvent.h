...
namespace OmniviewXEngine
{
    ...
    {
    public:
        MouseCodes GetMouseButton() {return m_Button;}
        EVENT_CLASS_CATEGORY(EventCategoryMouse | EventCategoryMouseButton | EventCategoryInput)
    protected:
        MouseButtonEvent(const MouseCodes mousecodes)
        :m_Button(mousecodes)
        {
    ...
    {
    public:
        MouseButtonPressedEvent(const MouseCodes mousecodes)
        :MouseButtonEvent(mousecodes)
        {
    ...
    {
    public:
        MouseButtonReleasedEvent(const MouseCodes mousecodes)
        :MouseButtonEvent(mousecodes)
        {
